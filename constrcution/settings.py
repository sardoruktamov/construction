"""
Django settings for constrcution project.
...
SECRET_KEY = 'j^*h006qgr2zcs$kmqz*42@wac+2mfdzv-ea-@=aq69nn#_=rr'
...
ROOT_URLCONF = 'constrcution.urls'
...
WSGI_APPLICATION = 'constrcution.wsgi.application'
